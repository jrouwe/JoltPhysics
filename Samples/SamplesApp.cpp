	...
	Application("Jolt Physics Samples", inCommandLine)
{
...

	{
		...
		mDebugUI->CreateTextButton(main_menu, "Drawing Options", [this]() {
			...
			mDebugUI->CreateCheckBox(drawing_options, "Draw Soft Body Rods", mBodyDrawSettings.mDrawSoftBodyRods, [this](UICheckBox::EState inState) { mBodyDrawSettings.mDrawSoftBodyRods = inState == UICheckBox::STATE_CHECKED; });
			mDebugUI->CreateCheckBox(drawing_options, "Draw Soft Body Rod Stretch Shear Constraints", mBodyDrawSettings.mDrawSoftBodyRodStretchShearConstraints, [this](UICheckBox::EState inState) { mBodyDrawSettings.mDrawSoftBodyRodStretchShearConstraints = inState == UICheckBox::STATE_CHECKED; });
			mDebugUI->CreateCheckBox(drawing_options, "Draw Soft Body Rod Bend Twist Constraints", mBodyDrawSettings.mDrawSoftBodyRodBendTwistConstraints, [this](UICheckBox::EState inState) { mBodyDrawSettings.mDrawSoftBodyRodBendTwistConstraints = inState == UICheckBox::STATE_CHECKED; });
