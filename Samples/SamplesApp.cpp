...

	{
		...
		mDebugUI->CreateTextButton(main_menu, "Drawing Options", [this]() {
			...
			mDebugUI->CreateTextButton(drawing_options, "Draw Soft Body", [this](){
				...
				mDebugUI->CreateCheckBox(draw_soft_body, "Draw Rod Stretch Shear Constraints", mBodyDrawSettings.mDrawSoftBodyRodStretchShearConstraints, [this](UICheckBox::EState inState) { mBodyDrawSettings.mDrawSoftBodyRodStretchShearConstraints = inState == UICheckBox::STATE_CHECKED; });
