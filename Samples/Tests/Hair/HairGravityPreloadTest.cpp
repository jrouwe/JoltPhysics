...
void HairGravityPreloadTest::Initialize()
{
	...
	{
		HairSettings::SVertex v;
		v.mPosition = Float3(1.0f * float(i), 0, 0);
		v.mInvMass = i == 0? 0.0f : 1.0f;
		hair_vertices.push_back(v);
	}
	hair_strands = { HairSettings::SStrand(0, cNumVertices, 0) };
#endif
