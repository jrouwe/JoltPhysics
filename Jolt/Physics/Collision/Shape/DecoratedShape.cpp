...
DecoratedShape::DecoratedShape(EShapeType inType, EShapeSubType inSubType, const DecoratedShapeSettings &inSettings, ShapeResult &outResult) :
	Shape(inType, inSubType, inSettings, outResult)
{
