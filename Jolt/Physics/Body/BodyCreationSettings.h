...
public:
	...
	bool					mAllowKinematicVsNonDynamic = false;							///< If kinematic objects can generate contact points against other kinematic or static objects. See description at Body::SetAllowKinematicVsNonDynamic.
